...
function UsersComponent() {
  ...
  const [nrOfOrders, setNrOfOrders] = useState(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const usersWithOrderCount = usersData.map((user) => {
      ...
      <tbody>
          {users?.length > 0 ? (
            ...
            {/* <td className='edit-btns'>
              ...
              <svg className='delete-svg' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 7H20" stroke="var(--purple)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M6 7V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V7" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7H9V5Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>

              </div>

              <div onClick={() => [setIsOpen(true), setProductDetail(prod)]}>
